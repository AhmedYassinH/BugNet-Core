namespace BugNetCore.Services.DataServices.Dal.Base
{
    public abstract class BaseDalDataService<TEntity, TDataService> : IBaseDataService<TEntity>
      where TEntity : BaseEntityWithAudit, new()
      where TDataService : class
    {
        ...
        public virtual async Task<TEntity> FindAsync(Guid id) => await _mainRepo.FindAsync(id);
