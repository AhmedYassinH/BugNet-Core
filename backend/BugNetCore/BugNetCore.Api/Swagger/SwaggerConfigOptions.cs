    ...
    public class SwaggerConfigOptions : IConfigureOptions<SwaggerGenOptions>
    {
            ...
            SwaggerApplicationSettings settings)
        {
            ...
            var info = new OpenApiInfo()
            {
                ...
                TermsOfService = new System.Uri("https://github.com/AhmedYassinH/BugNet-Core"),
                License = new OpenApiLicense() { Name = "MIT", Url = new System.Uri("https://github.com/AhmedYassinH/BugNet-Core/blob/main/LICENSE") }
            };
