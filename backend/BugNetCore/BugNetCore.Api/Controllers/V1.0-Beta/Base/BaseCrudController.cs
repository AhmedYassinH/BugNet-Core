namespace BugNetCore.Api.Controllers.V1._0_Beta.Base
{
    ...
    public class BaseCrudController<TEntity, TController, TCreateRequestDto, TUpdateRequestDto, TResponseDto> : ControllerBase
        ...
        where TUpdateRequestDto : BaseEntity, new()
        where TResponseDto : BaseEntity, new()

    {
        ...
        [HttpGet]
        public async virtual Task<ActionResult<ReadAllRecordsResponseBaseDto<TResponseDto>>> GetAll(
            ...
            )
        {
            ...
            var entityResponseDto = _mapper.Map<IEnumerable<TResponseDto>>(entities).ToList();
            var readAllEntitiesResponse  = new ReadAllRecordsResponseBaseDto<TResponseDto>
            {
        ...
        [SwaggerResponse(500, "An internal server error has occurred")]
        [HttpGet("{id}")]
        public async virtual Task<ActionResult<TResponseDto>> GetOneAsync(Guid id)
        {
        ...
        [SwaggerResponse(500, "An internal server error has occurred")]
        [HttpPut("{id}")]
        public async virtual Task<ActionResult<TResponseDto>> UpdateOneAsync([FromRoute] Guid id, [FromForm] TUpdateRequestDto entity)
        {
        ...
        [SwaggerResponse(500, "An internal server error has occurred")]
        [HttpDelete("{id}")]
        public async virtual Task<ActionResult> DeleteOneAsync(Guid id, BaseDto entity)
        {
